...
#     ./import_openssl.sh import /path/to/openssl-1.0.1m.tar.gz
#
...
target_c_includes := $(addprefix openssl/,$(common_c_includes)) $(local_c_includes)
...
host_c_includes := $(addprefix openssl/,$(common_c_includes)) $(local_c_includes)
